...
public class CharacterContract extends CharacterDecorator {
    ...
    public void goLeft() {
        ...
        if((nat_left == Cell.PLT || nat_left == Cell.MTL || nat_left == Cell.TRP) && getCol() != col_pre)
        ...
        if(nat != Cell.LAD && nat != Cell.HDR
           && nat_below != Cell.PLT && nat_below != Cell.MTL && nat_below != Cell.LAD && nat_below != Cell.TRP
        ...
        //           || getEnvi().getCellNature(getCol()@pre, getHgt()-1) \in { PLT, MTL, LAD, TRP }
        ...
        //       => getCol() == getCol()@pre - 1
        if(col_pre != 0
           && nat_left != Cell.PLT && nat_left!= Cell.MTL && nat_left!= Cell.TRP
    ...
    public void goRight() {
        ...
        if((nat_right == Cell.PLT || nat_right == Cell.MTL || nat_right == Cell.TRP) && getCol() != col_pre)
        ...
        //       => getCol() == getCol()@pre + 1
        if(col_pre != 0
           && nat_right != Cell.PLT && nat_right != Cell.MTL && nat_right != Cell.TRP
           && (nat == Cell.LAD || nat == Cell.HDR
               || nat_below == Cell.PLT || nat_below == Cell.MTL || nat_below == Cell.LAD || nat_below == Cell.TRP
               || char_below)
    ...
    public void goUp() {
        ...
        if(getEnvi().getCellNature(getCol(), hgt_pre) == Cell.LAD
           && (nat_above != Cell.PLT && nat_above != Cell.MTL && nat_above != Cell.TRP)
    ...
    public void goDown() {
        ...
        //       && \not \exists Guard g \in getEnvi().getCellContent(getCol(), getHgt()@pre-1)
        //       => getHgt() == getHgt()@pre - 1
        if((nat_below != Cell.PLT && nat_below != Cell.MTL && nat_below != Cell.TRP)
           && !guard_below
           && getHgt() != hgt_pre-1)
