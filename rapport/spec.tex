...
\begin{longtable}{rl}
  ...
  & \textrm{WillFall(P)} \textbf{implies} \textrm{Step(P)} = \textrm{GoDown(P)} \\

  & \textbf{not} \texttt{WillFall(P)} \textbf{implies} \\
  & \quad\quad (\textrm{Engine::NextCommand(Engine(P))} = Left \textbf{implies} \textrm{Step(P)} = \textrm{GoLeft(P)} \\
  & \quad\quad \textbf{and} \textrm{Engine::NextCommand(Engine(P))} = Right \textbf{implies} \textrm{Step(P)} = \textrm{GoRight(P)} \\
  & \quad\quad \textbf{and} \textrm{Engine::NextCommand(Engine(P))} = Up \textbf{implies} \textrm{Step(P)} = \textrm{GoUp(P)} \\
  & \quad\quad \textbf{and} \textrm{Engine::NextCommand(Engine(P))} = Down \textbf{implies} \textrm{Step(P)} = \textrm{GoDown(P)}) \\

  & (\textbf{not} \texttt{WillFall(P)} \\
  & \quad\quad \textbf{and} \textrm{Engine::NextCommand(Engine(P))} = DigL \\
  & \quad\quad \textbf{and} (\textrm{Environment::CellNature(Envi(P),Col(P),Hgt(P)-1)} \textbf{in} \{\textbf{PLT},\textbf{MTL},\textbf{LAD}\} \\
  & \quad\quad\quad\quad \textbf{or} \textbf{exist} Character c \textbf{in} \textrm{Environment::CellContent(Envi(P),Col(P),Hgt(P)-1)}) \\
  & \quad\quad \textbf{and} \textrm{Environment::CellNature(Envi(P),Col(P)-1,Hgt(P))} \textbf{in} \{\textbf{EMP},\textbf{HOL},\textbf{LAD},\textbf{HDR}\} \\
  & \quad\quad \textbf{and} \textrm{Environment::CellContent(Envi(P),Col(P)-1,Hgt(P))} \textbf{empty} \\
  & \quad\quad \textbf{and} \textrm{Environment::CellNature(Envi(P),Col(P)-1,Hgt(P)-1)} = \textbf{PLT}) \\
  & \quad\quad \textbf{implies} \textrm{Environment::CellNature(Envi(Step(P)),Col(P)-1,Hgt(P)-1)} = \textbf{HOL} \\

  & (\textbf{not} \texttt{WillFall(P)} \\
  & \quad\quad \textbf{and} \textrm{Engine::NextCommand(Engine(P))} = DigR \\
  & \quad\quad \textbf{and} (\textrm{Environment::CellNature(Envi(P),Col(P),Hgt(P)-1)} \textbf{in} \{\textbf{PLT},\textbf{MTL},\textbf{LAD}\} \\
  & \quad\quad\quad\quad \textbf{or} \textbf{exist} Character c \textbf{in} \textrm{Environment::CellContent(Envi(P),Col(P),Hgt(P)-1)}) \\
  & \quad\quad \textbf{and} \textrm{Environment::CellNature(Envi(P),Col(P)+1,Hgt(P))} \textbf{in} \{\textbf{EMP},\textbf{HOL},\textbf{LAD},\textbf{HDR}\} \\
  & \quad\quad \textbf{and} \textrm{Environment::CellContent(Envi(P),Col(P)+1,Hgt(P))} \textbf{empty} \\
  ...
  & \textrm{Engine::NextCommand(Engine(P))} \textbf{in} \{\textbf{DigL},\textbf{DigR},\textbf{Neutral}\} \\
  & \quad\quad \textbf{implies} \textrm{Col(Step(P))} = \textrm{Col(P)} \textbf{and} \textrm{Hgt(Step(P))} = \textrm{Hgt(P)} \\
