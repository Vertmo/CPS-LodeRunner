...
\begin{longtable}{rl}
  ...
  & \quad\quad\quad\quad \textbf{and} \textrm{HP(G)} $> 0$.\\
  \textbf{Observations}:&\\
  ...
  & \quad\quad \textbf{implies} (\textrm{HP(CheckStateAndUpdate(G))} $=$ \textrm{HP(G)-1}\\
  & \quad\quad\quad\quad \textbf{and} \textrm{Engine(CheckStateAndUpdate(G))} $=$ \\
  ...
  & \textrm{Status(Engine(CheckAndUpdate(G)))} $\neq$ \textbf{Loss} \textbf{implies} \textrm{HP(CheckAndUpdate(G))} $=$ \textrm{HP(G)}\\
  & \textrm{Status(Engine(G))} $=$ \textbf{Win}\\
  & \quad\quad \textbf{implies} (\textrm{Score(CheckStateAndUpdate(G))} $=$ \textrm{Score(G)} $+$ \textrm{LevelScore(Engine(G))}\\
  & \quad\quad\quad\quad \textbf{and} \textrm{LevelIndex(CheckStateAndUpdate(G))} $=$ \textrm{LevelIndex(G)} $+$ 1\\
  & \quad\quad\quad\quad \textbf{and} (\textrm{LevelIndex(CheckStateAndUpdate(G))} $<$ \textrm{$|$Levels(G)$|$} \textbf{implies}\\
  ...
  & \textrm{Status(Engine(CheckAndUpdate(G)))} $\neq$ \textbf{Win} \textbf{implies} \textrm{LevelIndex(CheckAndUpdate(G))} $=$ \textrm{LevelIndex(G)}\\
  & \textrm{Status(Engine(CheckAndUpdate(G)))} $=$ \textbf{Playing} \textbf{implies} \textrm{Engine(CheckAndUpdate(G))} $=$ \textrm{Engine(G)}\\
\end{longtable}}
